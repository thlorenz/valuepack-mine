 ...
 *
 * Additionally it fills in the user's github login by deducing it from the package reposcorrects all byGitub entryies that weren't added before b/c the user didn't provide it.
 *
 * @name exports
 * @function
...
var go = module.exports = function (db) {
  ...
  function onuser (user) {
    ...
    byOwner
      ...
      .pipe(concatStream(function () { log.verbose('get-github-logins', 'github logins', Object.keys(githubLogins)); }));
  }
